      ...
      <div className="img-container">
        ...
        {isHovering && (
          <div className="DoubleButton">
            <button
              className="hoveredButton1"
              onMouseEnter={showHoverEye}
              onMouseLeave={hideHoverEye}
            >
              {" "}
              {eyeHovering && <img className="Eyes" src="/Eyes.png" />} Quick
              View{" "}
            </button>
            <Link
              to={`/product/${id}`}
              className="hoveredButton2"
              onMouseEnter={showHoverBag}
              onMouseLeave={hideHoverBag}
            >
              {" "}
              {bagHovering && <img className="Bag" src="/Bag.png" />}Read More
            </Link>
          </div>
        )}
        <div
