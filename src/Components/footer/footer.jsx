      ...
      <div>
        ...
        <div>
          ...
          <div className="flex flex-row items-center gap-5">
            <img className="cursor-pointer hover:opacity-70 transition-all duration-200 h-14 w-14" src="/Instagram.svg" />
            <img className="cursor-pointer hover:opacity-70 transition-all duration-200 h-14 w-14" src="/TikTok.svg" />
            <img className="cursor-pointer hover:opacity-70 transition-all duration-200 h-14 w-14" src="/Facebook.svg" />
          </div>
        </div>
      </div>
